...
Esta simplicidad contrasta con alternativas existentes. Plataformas como Arduino, aunque requieren conocimientos mínimos de electrónica y programación, quitan tiempo relevante durante clase.\\
...
Además de la accesibilidad del sistema propuesto, destaca por su escalabilidad y bajo costo. Por menos de \$500 MXN se consigue una Raspberry Pi capaz de implementar una infraestructura como la planteada. Su arquitectura modular gracias al MVC permite mejoras futuras sin modificar la base del código.\\
